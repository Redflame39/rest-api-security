    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.POST, "/users/**/orders").hasAnyRole("USER", "ADMIN")
                    .antMatchers(HttpMethod.POST, "/certificates", "/tags").hasRole("ADMIN")
                    .antMatchers(HttpMethod.PUT, "/certificates", "/tags").hasRole("ADMIN")
                    .antMatchers(HttpMethod.DELETE, "/certificates", "/tags").hasRole("ADMIN")
